...
function PostCard({ post }: PostCardProps) {
  return (
    <article className="group relative p-8 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:bg-white dark:hover:bg-gray-700 transform hover:-translate-y-1 transition-all duration-300 ease-in-out shadow-sm hover:shadow-md dark:shadow-gray-900/10">
      ...
      <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">
        {post.title}
      </h2>
      ...
      <div className="mt-6 flex items-center justify-between">
        ...
        <button className="group/btn flex items-center space-x-2 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors duration-200">
          <span>
